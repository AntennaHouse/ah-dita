...
<!--    2022.12.17 AH:  Update for flowchart task                  -->
<!-- ============================================================= -->
...
<!ENTITY % choicecond  "choicecond"                                  >
<!ENTITY % choiceproc  "choiceproc"                                  >
...
<!--                    LONG NAME: Choice Condition                -->
<!ENTITY % choicecond.content
                     "(%basic.fc.ph.cnt;)*"
>
<!ENTITY % choicecond.attributes
             "id 
                        ID 
                                  #IMPLIED
              %conref-atts;
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT choicecond    %choicecond.content;>
<!ATTLIST choicecond    %choicecond.attributes;>

<!--                    LONG NAME: Choice Procedure                -->
<!ENTITY % choiceproc.content
                     "(%basic.fc.with.pcdata.cnt;|%nextstep;)*"
>
<!ENTITY % choiceproc.attributes
             "id 
                        ID 
                                  #IMPLIED
              %conref-atts;
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT choiceproc    %choiceproc.content;>
<!ATTLIST choiceproc    %choiceproc.attributes;>

<!--                    LONG NAME: Next Step                      -->
<!ENTITY % nextstep.content
                     "EMPTY"
>
<!ENTITY % nextstep.attributes
             "id 
                        ID 
                                  #IMPLIED
              %conref-atts;
              ...
              outputclass 
                        CDATA 
                                  #IMPLIED"
>
<!ELEMENT nextstep      %nextstep.content;>
<!ATTLIST nextstep      %nextstep.attributes;>
...
<!ATTLIST  choicecond   %global-atts;  class  CDATA "- topic/ph task/choicecond "     >
<!ATTLIST  choiceproc   %global-atts;  class  CDATA "- topic/div task/choiceproc "    >
<!ATTLIST  nextstep     %global-atts;  class  CDATA "- topic/ph task/nextstep "       >
